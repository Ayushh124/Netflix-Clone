...
class VideoPlayerActivity: AppCompatActivity() { // Changed to AppCompatActivity
        ...
        setContent {
                Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
                    AndroidViewBinding(
                        ...
                        update = {
                            if (player == null) {
                                player = ExoPlayer.Builder(this.root.context).build().apply {
